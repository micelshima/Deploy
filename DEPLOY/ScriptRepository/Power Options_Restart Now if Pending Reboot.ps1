...
{
Append-Richtextbox -ComputerName $computername -Source $scriptbasename -Message "Reiniciando $computername" -MessageColor 'blue' -logfile 'ps1command.log'
...
{
Append-Richtextbox -ComputerName $computername -Source $scriptbasename -Message "No es necesario reiniciar $computername" -MessageColor 'green' -logfile 'ps1command.log'
}