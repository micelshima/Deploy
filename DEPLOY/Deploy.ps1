...
$css = [pscustomobject]@{
	...
	formcolorUX  = [System.Drawing.Color]::MediumVioletRed
...
$tabControl1.Add_SelectedIndexChanged( {
		switch ($tabcontrol1.SelectedTab) {
			...
			$tabPage3 {$Form1.backcolor = $css.formcolorUX}
...
$TreeViewtxt.Add_AfterSelect( {
		...
		$script:txtfilebasename = $_.Node.FULLPATH
...
$buttonopenrepo.Location = new-object System.Drawing.Point(475, 55)
$buttonopenrepo.Size = New-Object System.Drawing.Size(100, 20)
$buttonopenrepo.font = $css.checkboxfont
...
$buttonopenlogs.Location = new-object System.Drawing.Point(575, 55)
...
$buttonopenresults.Location = new-object System.Drawing.Point(625, 55)
